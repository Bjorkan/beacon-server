...
func (m *MockQuerier) ResolvePathHashesP1(ctx context.Context, dollar_1 [][]byte) ([]db.ResolvePathHashesP1Row, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ResolvePathHashesP2(ctx context.Context, dollar_1 [][]byte) ([]db.ResolvePathHashesP2Row, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ResolvePathHashesP3(ctx context.Context, dollar_1 [][]byte) ([]db.ResolvePathHashesP3Row, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ResolvePathHashesP4(ctx context.Context, dollar_1 [][]byte) ([]db.ResolvePathHashesP4Row, error) {
	m.ctrl.T.Helper()
